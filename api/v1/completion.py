...
class CompletionAPI(Resource):
    ...
    "permissions": ["models.open_ai_azure_api.completion.post"],
    "recommended_roles": {
    ...
    def post(self, project_id: int, integration_uid: str, deployment_id: str, **kwargs):
        ...
        try:
            request_data = CompletionRequest.parse_obj(payload)
        ...
        result = AIProvider.completion(project_id, integration, request_data)
        if not result['ok']:
